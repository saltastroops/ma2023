...
function ma2023_payment_form($userId, $name, $email, $amount) {
    ...
    <label>Email address for the confirmation <input type="email" name="emailAddress" value="' . $email . '"></label>
    <input type="hidden" name="shouldSendEmail" value="1"> 
...
add_shortcode( 'payment', function () {
    ...
    return ma2023_payment_form($userId, $surname, $email, $amount);
});
